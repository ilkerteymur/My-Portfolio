            ...
            <div className="contact__info">
              <div className="contact__card">
                ...
                <span className="contact__card-data">
                  ilkerteymuroglu@gmail.com
                </span>
                <a
                  href="mailto:ilkerteymuroglu@gmail.com"
                  target="_blank"
              ...
              <div className="contact__info">
                <div className="contact__card">
                  ...
                  <span className="contact__card-data">+905413802696</span>
                  <a
                    href="https://api.whatsapp.com/send?phone=905413802696&text=Hello, more information!"
                    target="_blank"
                    className="contact__button"
                    rel="noreferrer"
                  >
              ...
              <div className="contact__info">
                <div className="contact__card">
                  ...
                  <span className="contact__card-data">Ilker TEYMUROGLU</span>
                  <a
                    href="https://m.me//"
                    className="contact__button"
                    target="_blank"
